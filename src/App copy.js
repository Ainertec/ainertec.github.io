  ...
  return (
    <div className="flex flex-col items-center">
      <div className="flex justify-center items-start">
        <img className="rounded-lg" src="https://lh3.googleusercontent.com/pw/AP1GczPqg0msE6etTZuTEd4c8crjZ7VGPMPuRq5e3WoBZbtosbVB8xAj-HurVcsXbb-jS5YC6ggySnZT90vh9mwGmQ-Ffh8cQAzjeTqXY2SkbN4X8IQqpFzkch5XD5DsizLA10cL5n4PwRl4W5EdHOoj5zLM=w1600-h480-s-no-gm" />
      </div>
      <div className="flex justify-center mt-2 gap-4 w-6/6 text-center items-center bg-white/10 p-4 mr-0 sm:mr-64 sm:w-3/6">
        <img className="w-1/6" src="https://lh3.googleusercontent.com/pw/AP1GczNdziV7sWkt7AS4fM9Fl5BfajdrxdiNW9-Y0dwD2BChy_n8poCVi9Lcz7ciuim6hsxgl-7KtIGixTYyHCwHUcf0G1dMsjchmbdLXL1rmqGzSN67t9immFb993-Z9bw2xRVtA6suDUM9fey5_E1fXfEo=w773-h773-s-no-gm" />
